    ...
    return (
        <>
            ...
            fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70">
                <div className="relative w-full lg:3/6 my-6 mx-auto lg:max-w-3xl h-full lg:h-auto">
                    {/*Content*/}
                    <div className="h-full lg-auto border-0 rounded-lg shadow-lg relative 
                    flex flex-col w-full bg-black outline-none focus:outline-none">
                        {/*Header*/}
                        <div className="flex icons-center justify-between p-10 rounded-t">
